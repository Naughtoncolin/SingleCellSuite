...
for item in ${sample_list[@]}; do
	...
	PICARD="/storage/home/hcoda1/0/cnaughton7/anaconda3/envs/beagle-env/bin/picard"
	SAMTOOLS="/storage/home/hcoda1/0/cnaughton7/anaconda3/envs/beagle-env/bin/samtools"
	GATK="/storage/home/hcoda1/0/cnaughton7/anaconda3/envs/beagle-env/bin/gatk "
	STAR="/storage/home/hcoda1/0/cnaughton7/anaconda3/envs/beagle-env/bin/STAR"
	...
	$STAR --runMode genomeGenerate --genomeDir $genome_dir --genomeFastaFiles $ref_fasta --sjdbGTFfile /storage/home/hcoda1/0/cnaughton7/p-ggibson3-0/Reference/gencode.v39.annotation.gtf --runThreadN 12 --genomeSAsparseD 3 --genomeSAindexNbases 12

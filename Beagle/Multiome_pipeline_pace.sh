...
sample_list=("sample1" "sample2" "pool2" "pool3")

for item in ${sample_list[@]}; do
	sample_name=$item
	folder_name="/storage/home/hcoda1/4/jkintzle3/p-ggibson3-0/VariantAnalysis/Multiome_"$sample_name
	mkdir -p $folder_name
	orig_bam="/storage/home/hcoda1/4/jkintzle3/p-ggibson3-shared/Multiome/bamFiles/"$sample_name"/gex_possorted_bam.bam"
	...
	ref_fasta="/storage/home/hcoda1/4/jkintzle3/p-ggibson3-0/GATK_hg38_ref/GATK_cloud/Homo_sapiens_assembly38.fasta"
	hg38_dbsnp="/storage/home/hcoda1/4/jkintzle3/p-ggibson3-0/GATK_hg38_ref/GATK_cloud/Homo_sapiens_assembly38.dbsnp138.vcf"
	hg38_known_indels="/storage/home/hcoda1/4/jkintzle3/p-ggibson3-0/GATK_hg38_ref/GATK_cloud/Homo_sapiens_assembly38.known_indels.vcf.gz"
	hg38_interval_list="/storage/home/hcoda1/4/jkintzle3/p-ggibson3-0/GATK_hg38_ref/GATK_cloud/Homo_sapiens_assembly38.known_indels.interval_list"
	...
	genome_dir="/storage/home/hcoda1/4/jkintzle3/p-ggibson3-0/VariantAnalysis/STAR_genome_dir"
	...
	#STAR --runMode genomeGenerate --genomeDir $genome_dir --genomeFastaFiles $ref_fasta --sjdbGTFfile /storage/home/hcoda1/4/jkintzle3/p-ggibson3-0/GATK_hg38_ref/gencode.v38.annotation.gtf --runThreadN 12 --genomeSAsparseD 3 --genomeSAindexNbases 12
